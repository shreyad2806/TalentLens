...
class ResumeMetadata(BaseModel):
    ...
    primary_role: str | None = Field(None, description="Canonical primary occupation extracted from work history")
    role_family: str | None = Field(None, description="Broader occupational family (e.g., Machine Learning, Software Engineering)")
    seniority: str | None = Field(None, description="Seniority level (e.g., Senior, Lead, Junior, Intern)")
